import LandingDog from '../../../assets/images/dog_baby.jpg';
const AdSection = () => {
    return (
        <div className='relative flex items-center '>
            <div className='text-white absolute content-center text-left pl-24 w-100 pt-20'>
                <div>
                    <div className='lg:block sm:hidden md:hidden hidden'>
                        <div className='lg:text-6xl sm:text-3xl font-mediump font-bold pt-3 pb-3'>Our Dogs </div>
